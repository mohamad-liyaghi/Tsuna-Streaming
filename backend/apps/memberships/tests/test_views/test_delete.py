...
class TestMembershipDelete:
    ...
    def test_delete_not_found(self, create_superuser, api_client, create_unique_uuid):
        api_client.force_authenticate(create_superuser)
        response = api_client.delete(
    ...
    def test_delete_in_use_plan(
        self, api_client, create_subscription, create_superuser
    ):
        api_client.force_authenticate(create_superuser)
        response = api_client.delete(
            reverse(
